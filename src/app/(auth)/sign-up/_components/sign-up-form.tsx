...
// import GoogleLoginButtonFixed from "@/components/modals/google-login-button-fixed";
...
//         <h3 className="text-2xl md:text-3xl lg:text-4xl font-normal text-[#131313] text-center leading-[120%] pt-2">
//           Create an account
//         </h3>
...
//           <GoogleLoginButtonFixed context="signup" />
//         </div>
