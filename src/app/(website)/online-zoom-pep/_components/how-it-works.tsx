    ...
    >
      <header className="absolute inset-x-[4%] top-[3.3%] z-10 text-center text-white md:top-[4.2%]">
        ...
        <h2
          ...
          className="mt-1 text-lg font-bold leading-none tracking-tight text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl"
        >
          Three Steps to Your Online Evaluation.
        </h2>
        <p className="mt-1 font-medium leading-none text-[11px] md:text-sm lg:text-base">
      ...
      <div className="absolute left-[14%] top-[13%] grid w-[72%] gap-2 md:left-[5.2%] md:top-[26%] md:w-[89.6%] md:grid-cols-3 md:gap-x-[3.5%]">
        {steps.map((step) => (
          ...
          >
            ...
            <div className="block h-[58%] w-full shrink-0 md:h-auto md:max-h-[58%]">
              <Image
                src={step.sm_image}
                alt=""
                aria-hidden
      ...
      <p className="absolute bottom-[2.5%] left-0 right-0 text-center font-medium text-white md:bottom-[4.1%] text-sm md:text-base lg:text-lg">
