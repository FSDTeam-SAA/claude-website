...
const PepHero = () => {
  ...
  return (
    <div className="relative max-w-[1400px] mx-auto w-[95%] md:w-full bg-[url('/assets/images/pep/sm_pep_hero.svg')] md:bg-[url('/assets/images/pep/lg_pep_hero.svg')] bg-cover bg-center bg-no-repeat min-h-[600px] md:h-[750px] py-10 md:py-16 lg:py-20 rounded-[30px] md:rounded-[70px] mt-6 md:mt-8 lg:mt-10 xl:mt-12 overflow-hidden flex flex-col justify-end pb-12 md:pb-0 md:justify-center">
      ...
      <div className="relative z-10 px-6 md:px-12 lg:px-20 w-full max-w-[1200px] mx-auto">
        <div className="flex flex-col gap-4 md:gap-12">
          ...
          <div className="flex flex-col gap-1 md:gap-2">
            <h2 className="text-primary text-base md:text-2xl lg:text-3xl font-medium leading-tight">
