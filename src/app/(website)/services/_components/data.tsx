        ...
        <div className="bg_color py-10 md:py-16 lg:py-20">
            <div className="container grid grid-cols-1 md:grid-cols-2 gap-10 ">
                <div className="md:col-span-1 h-full flex flex-col justify-center">
                    <h3 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-primary leading-[150%] h_underline pb-2 md:pb-5 lg:pb-6">Data</h3>
                    ...
                    >
                        <button className="w-[250px] md:w-[300px] h-[44px] md:h-[50px] lg:h-[56px] bg-primary text-black ease-in-out duration-200 transition-all py-3 px-5 md:px-6 rounded-full text-sm md:text-base lg:text-lg font-medium leading-[120%]">
                            Get Your Player Report
                        </button>
                    </Link>
                </div>
                <div className="md:col-span-1">
                    <Image src="/assets/images/new_data.jpeg" alt="data" width={500} height={500} className='w-full h-[400px] md:h-[550px] lg:h-[678px] object-contain  !rounded-[16px]  ' />
                </div>
            </div>
        </div>
    )
