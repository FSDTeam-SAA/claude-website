...
const TeamsPlayer = () => {
  ...
  return (
    <div className="bg-white py-7 md:py-16 lg:py-24 ">
      <div className="container ">
        <h3 className="text-2xl md:text-3xl lg:text-[40px] text-primary leading-normal h_underline font-normal text-center line-clamp-2 md:line-clamp-1">
          Pricing For Teams (minimum 10 players)
        </h3>
      ...
      {teamIsOpen && subscriptionId && (
        <RegisterAsTeamPlayerForm
          open={teamIsOpen}
          onOpenChange={setTeamIsOpen}
          subscriptionId={subscriptionId}
          subscriptionTitle={
            selectedSubscription?.title ||
            `${selectedSubscription?.numberOfGames || ""} games`
          }
