...
const formSchema = z
  .object({
    ...
    citizenship: z.string().trim().min(2, {
...
const PersonalInformationForm: React.FC<PersonalInformationFormProps> = ({
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      currentClub: user?.currentClub?.trim() || "",
      league: user?.league || "",
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Popover>
                      ...
                      <PopoverContent
                        className="w-auto p-2 bg-white border-none"
                        align="start"
                      >
                        <Calendar
                          mode="single"
                    ...
                    <FormControl>
                      ...
                      >
                        ...
                        <SelectContent className="h-[200px] overflow-y-auto bg-white border-none">
                          <SelectItem className="cursor-pointer" value="nwsl">
                            NWSL
                          </SelectItem>
                          <SelectItem className="cursor-pointer" value="ecnl">
                            ECNL
                          </SelectItem>
                          <SelectItem
                            className="cursor-pointer"
                            value="usl super league"
                          >
                            USL Super League
                          </SelectItem>
                          ...
                          <SelectItem className="cursor-pointer" value="npl">
                            NPL
                          </SelectItem>
                          <SelectItem className="cursor-pointer" value="pdl">
                            PDL
                          </SelectItem>
                          <SelectItem
                            className="cursor-pointer"
                            value="upsl division 1"
                          >
                            UPSL Division 1
                          </SelectItem>
                          <SelectItem
                  ...
                  <FormControl>
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <label
                          htmlFor="yes"
                          className="cursor-pointer text-base font-medium text-[#131313]"
                        >
                          Yes
                        </label>
                      </div>
            ...
            <div className="w-full flex items-center justify-end">
              <Button
                className="h-[48px] px-10 py-2 rounded-[10px] text-base font-semibold text-white leading-[120%]"
                disabled={isPending}
                type="submit"
              >
